function [output] = Preproc_HCPData_PostMinPreproc_TaskRest_CanonicalHRFModel_v2(SUBJECTLIST)
...
ANALYSISNAME_NEW='TaskFCMethods_HCPData_CanonicalHRFNoInterp';
...
for subjIndex=1:numSubjs
    ...
    savedfile=[subjTemporaryAnalysisDir mfilenameRep '_' ANALYSISNAME_NEW '_TaskRegressorVars.mat'];
